...
networks = {}
net_optionsF = {'userelu': False, 'in_planes':3, 'out_planes':[20,20,128,128], 'num_stages':4}
pretrainedF = './experiments/miniImageNet_Conv128CosineClassifier_base20/feat_model_net_epoch*.best'
...
pretrainedC = './experiments/miniImageNet_Conv128CosineClassifier_base20/classifier_net_epoch*.best'
