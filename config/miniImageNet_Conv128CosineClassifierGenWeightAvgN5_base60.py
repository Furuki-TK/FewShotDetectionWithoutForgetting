...
networks = {}
net_optionsF = {'userelu': False, 'in_planes':3, 'out_planes':[60,60,128,128], 'num_stages':4}
pretrainedF = './experiments/miniImageNet_Conv128CosineClassifier_base60/feat_model_net_epoch*.best'
...
pretrainedC = './experiments/miniImageNet_Conv128CosineClassifier_base60/classifier_net_epoch*.best'
