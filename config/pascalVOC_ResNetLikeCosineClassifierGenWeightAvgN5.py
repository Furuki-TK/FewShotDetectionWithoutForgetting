...
pretrainedF = './experiments/pascalVOC_ResNetLikeCosineClassifier/feat_model_net_epoch*.best'
...
pretrainedC = './experiments/pascalVOC_ResNetLikeCosineClassifier/classifier_net_epoch*.best'
