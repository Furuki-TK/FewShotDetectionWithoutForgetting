...
networks = {}
net_optionsF = {'userelu': False, 'in_planes':3, 'out_planes':[10,10,64,64], 'num_stages':4}
pretrainedF = './experiments/pascalVOC_Conv64CosineClassifier/feat_model_net_epoch*.best'
...
pretrainedC = './experiments/pascalVOC_Conv64CosineClassifier/classifier_net_epoch*.best'
