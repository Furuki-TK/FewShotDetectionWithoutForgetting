...
networks = {}
net_optionsF = {'userelu': False, 'in_planes':3, 'out_planes':[40,40,128,128], 'num_stages':4}
pretrainedF = './experiments/miniImageNet_Conv128CosineClassifier_base40/feat_model_net_epoch*.best'
...
pretrainedC = './experiments/miniImageNet_Conv128CosineClassifier_base40/classifier_net_epoch*.best'
