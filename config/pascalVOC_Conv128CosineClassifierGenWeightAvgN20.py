...
data_test_opt['nTestNovel'] = 5 * data_test_opt['nKnovel']
data_test_opt['nTestBase'] = 5 * data_test_opt['nKnovel']
...
networks = {}
net_optionsF = {'userelu': False, 'in_planes':3, 'out_planes':[10,10,128,128], 'num_stages':4}
pretrainedF = './experiments/pascalVOC_Conv128CosineClassifier/feat_model_net_epoch*.best'
...
pretrainedC = './experiments/pascalVOC_Conv128CosineClassifier/classifier_net_epoch*.best'
