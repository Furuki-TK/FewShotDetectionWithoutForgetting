# -*- coding: utf-8 -*-
"""Launches routines that train (fewshot) recognition models on PascalVOC.

Example of usage:
For our proposed approach proposed:

    # 1st training stage: trains a cosine similarity based recognition model.
    CUDA_VISIBLE_DEVICES=0 python train_voc.py --config=pascalVOC_Conv128CosineClassifier
    ...
    # generator:
    CUDA_VISIBLE_DEVICES=0 python train.py --config=pascalVOC_Conv128CosineClassifierGenWeightAttN1 # 1-shot case.
    CUDA_VISIBLE_DEVICES=0 python train.py --config=pascalVOC_Conv128CosineClassifierGenWeightAttN5 # 5-shot case.
